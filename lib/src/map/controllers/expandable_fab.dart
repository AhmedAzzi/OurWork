...
class tLoctionController extends StatefulWidget {
  const tLoctionController(
  ...
  _tLoctionControllerState createState() => _tLoctionControllerState();
}

// ignore: camel_case_types
class _tLoctionControllerState extends State<tLoctionController>
